...
VALUES
('Ravi Shankar Reddy',  '9849100001', 'ravi.shankar@gmail.com',  'Seller', 'Banjara Hills', 'Existing Client', NULL, NULL, 'Long-standing client. Premium property owner.'),
('Suresh Babu Goud',    '9849100002', NULL,                        'Seller', 'Kompally',      'Referral',        NULL, NULL, 'Has two residential plots in north Hyderabad.'),
...
('Srinivas Rao Choudary','9849100005', NULL,                       'Seller', 'Manikonda',     'Referral',        NULL, NULL, 'Builder network referral. Selling villa in Kokapet.'),
('Mahesh Kumar Jain',   '9849100006', 'mahesh.jain@gmail.com',   'Seller', 'Medchal',       'Advertisement',   NULL, NULL, 'Responded to our ad. Commercial land near ORR.'),
('Deepak Choudhary',    '9849100007', NULL,                        'Seller', 'Narsingi',      'Referral',        'Ramakrishna Nair', NULL, 'Contact and villa sourced through external agent.'),
('Nandini Agarwal',     '9849100008', 'nandini.a@gmail.com',     'Seller', 'Manikonda',     'Existing Client', NULL, NULL, 'Has residential and commercial plots on city outskirts.'),
('Kiran Tej Malhotra',  '9849100009', 'kiran.malhotra@outlook.com','Buyer', 'Gurgaon',      'Referral',        NULL, 1, 'Relocating to Hyderabad. HNI investor. Referred by Ravi Shankar.'),
('Aditya Sharma',       '9849100010', 'aditya.s@gmail.com',      'Buyer', 'Ameerpet',      'Property Portal', NULL, NULL, 'First-time buyer. Wants retail space for own business.'),
('Sunita Krishnan',     '9849100011', NULL,                        'Buyer', 'Kondapur',      'Referral',        NULL, NULL, 'Buying villa for personal use. Flexible budget.'),
('Vamsi Krishna Reddy', '9849100012', 'vamsi.k@gmail.com',       'Buyer', 'Manikonda',     'Existing Client', NULL, NULL, 'Upgrading from apartment to independent villa.'),
('Rohit Gupta',         '9849100013', 'rohit.gupta@corp.in',     'Buyer', 'Delhi',         'Advertisement',   NULL, NULL, 'NRI investor. Looking for commercial land near ORR.'),
('Lakshmi Prasad Naidu','9849100014', NULL,                        'Buyer', 'Banjara Hills', 'Referral',        NULL, 4, 'Ultra HNI. Premium villa or office investment. Referred by Padma.'),
('Faisal Ahmed',        '9849100015', 'faisal.a@business.com',   'Buyer', 'Hyderabad',     'Walk-in',         NULL, NULL, 'Retail business owner. Wants space in Banjara Hills.'),
('Harish Naidu',        '9849100016', NULL,                        'Buyer', 'Kokapet',       'Referral',        NULL, 12,'Wants plot to build own house. Referred by Vamsi.'),
('Ramesh Chandra Rao',  '9849100017', 'ramesh.rao@gmail.com',    'Both',  'Hyderabad',     'Existing Client', NULL, NULL, 'Sold villa in Manikonda. Now upgrading to Jubilee Hills.'),
('Naveen Kumar Reddy',  '9849100018', 'naveen.r@rediffmail.com', 'Both',  'Ameerpet',      'Existing Client', NULL, NULL, 'Sold retail space. Now exploring commercial plot.'),
('Kavitha Murthy',      '9849100019', NULL,                        'Both',  'Kukatpally',    'Referral',        NULL, 17,'Looking for commercial plot. Referred by Ramesh Rao.'),
('Tejashwini Patel',    '9849100020', 'teju.patel@gmail.com',    'Buyer', 'Kompally',      'Referral',        NULL, 2, 'Young couple. Plot in north Hyderabad. Referred by Suresh.');
